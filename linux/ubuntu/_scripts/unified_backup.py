#!/usr/bin/env python3
"""
Comprehensive Unified Backup Script (Improved)
-----------------------------------------------
Description:
  ...
  This script integrates rich library progress spinners, detailed Nord-themed logging,
  strict error handling, and graceful signal cleanup.
...
# Retention policy and retry configuration
RETENTION_DAYS = 7
MAX_RETRIES = 3
...
def main():
    ...
    logging.info("=" * 80)
    logging.info(
        f"UNIFIED BACKUP COMPLETED WITH {summary} AT {now} (took {elapsed:.1f} seconds)"
    )
    logging.info("=" * 80)
