# Please review the following guidelines thoroughly. This reference serves as the comprehensive template for all future Python scripts you generate on my behalf. All scripts must strictly adhere to the structure, style, and best practices demonstrated below, optimized for an Ubuntu environment
