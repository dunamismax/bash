...
install_enlightenment() {
  ...
  apt install -y xfce4 i3 rofi i3lock i3blocks feh xterm alacritty ranger network-manager network-manager-gnome pavucontrol alsa-utils picom polybar fonts-powerline fonts-noto
