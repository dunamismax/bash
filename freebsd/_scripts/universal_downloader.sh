...
#              downloading with wget or yt-dlp on FreeBSD. For yt-dlp, the script
...
#   This script will attempt to install missing dependencies using pkg.
#
# ------------------------------------------------------------------------------
...
install_prerequisites() {
    ...
    pkg update -f || handle_error "Failed to update repositories."
    pkg install -y wget yt-dlp ffmpeg || handle_error "Failed to install prerequisites."
