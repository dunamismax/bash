...
# Variables
export RESTIC_REPOSITORY="/mnt/media/WD_BLACK/BACKUPS/Plex-Media-Server"
export RESTIC_PASSWORD_FILE="/root/.restic-password"
SOURCE_DIR="/var/lib/plexmediaserver/Library/Application Support/Plex Media Server"
LOG_FILE="/var/log/restic-plex-backup.log"
RETENTION_DAYS=30
SNAPSHOT_TAG="Plex-$(date +"%Y-%m-%d")"
...
log "--------------------------------------"
log "Starting Plex Restic Backup Script"
